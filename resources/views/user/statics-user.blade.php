        ...
        <div class="divone">
            <div class="statics">
                ...
                <div class="flex cards">
                    <div class="card card1"><i class="fa-solid fa-users"></i>Notifications : {{ $usersCount }}</div>
                    <div class="card card2"><i class="fa-solid fa-people-group"></i>Enrolled : {{ $teachersCount }}
                    </div>
                    <div class="card card3"><i class="fa-solid fa-user-secret"></i>Progress : {{ $adminsCount }}
                    </div>
                    <div class="card card4"><i class="fa-solid fa-spinner"></i>Followers :
                        {{ $currentMonthUsers }}
                    </div>
                    <div class="card card5"><i class="fa-solid fa-spinner"></i>Overview Courses :
                        {{ $currentMonthUsers }}
                    </div>
                </div>
            </div>
                    ...
                    <li>
                        <div class="flex tech gap">
                            <a href="{{ route('profile.index', ['user' => $teacher->id]) }}" class="follower-item gap">
                                <div class="follower-avatar"><img src="{{ asset($teacher->image) }}" alt="">
                                </div>
